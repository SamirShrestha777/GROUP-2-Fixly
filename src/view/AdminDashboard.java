...
public class AdminDashboard extends javax.swing.JFrame {
    ...
    public void initTechnicianPanel() {
    ...
    public void loadTechnicians(java.util.List<model.UserData> list) {
        technicianPanel.removeAll();
        if (list.isEmpty()) {
            javax.swing.JLabel empty = new javax.swing.JLabel("No technicians found.");
            empty.setForeground(java.awt.Color.WHITE);
            empty.setAlignmentX(java.awt.Component.CENTER_ALIGNMENT);
            technicianPanel.add(empty);
        } else {
            for (model.UserData t : list) {
    ...
    private AdminTechnicianCard createTechnicianCard(model.UserData t) {
        AdminTechnicianCard card = new AdminTechnicianCard();
        card.setCardData(t.getSpecialization(), t.getUsername(), t.getEmail(), t.getAccountStatus());
        card.setAlignmentX(java.awt.Component.LEFT_ALIGNMENT);
        return card;
    }
    ...
    public void addMonitorNavListener(java.awt.event.ActionListener l) {
        bookingbtn.addActionListener(l);
    }
