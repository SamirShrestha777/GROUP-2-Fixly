...
public class ForgotPassword extends javax.swing.JFrame {
        ...
        private void initComponents() {
                ...
                txtboxemail.putClientProperty("JTextField.roundRect", true); // Makes text field rounded
                ...
                backtologin.putClientProperty("JButton.buttonType", "roundRect"); // Makes button rounded
                backtologin.putClientProperty("JButton.arc", 999);
                ...
                sndbutton.putClientProperty("JButton.buttonType", "roundRect"); // Makes button rounded
                sndbutton.putClientProperty("JButton.arc", 999);
